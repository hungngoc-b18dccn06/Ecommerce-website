<template>
  <div class="hotline-phone-ring-wrap">
    ...
    <div class="hotline-bar">
      <a href="tel:0898982526">
        <span class="text-hotline" style="display: inherit">09 789 999</span>
      </a>
    </div>
  </div>
  ...
  <div class="float-icon-hotline">
    <ul class="left-icon hotline">
      <li class="hotline_float_icon">
        <a target="_blank" rel="nofollow" id="messengerButton" href="https://zalo.me/0983729020"><i
            class="fa fa-zalo animated infinite tada"></i><span>Zalo</span></a>
      </li>
      <li class="hotline_float_icon">
        <a target="_blank" rel="nofollow" id="messengerButton" href="#"><i
